...
export default class TicketSlaRemedy extends Component {
  ...
  render(){
    var label = <label>{this.props.statusTxt}</label>
    var worklog = <TextField fullWidth={true} multiLine={true} rows={2} onChange={this.worklog} hintText="Worklog กรอกภาษาอังกฤษเท่านั้น" floatingLabelText="Worklog" />;
