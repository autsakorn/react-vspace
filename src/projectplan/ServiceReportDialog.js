...
class ServiceReportDialog extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      creatingService:true,openSnackbar:false,messageSnackbar:''
    };
  }
  handleOpen = () => {
  ...
  render(){
    ...
    var viewAppointment = <span onTouchTap={()=>{this.setState({open:true,creatingService:!this.state.creatingService}) }}>({this.props.serviceReport.length}) <ActionPageview style={{color:lightBlack}} /></span>
